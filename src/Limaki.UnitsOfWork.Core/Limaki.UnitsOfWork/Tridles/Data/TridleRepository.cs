...
namespace Limaki.UnitsOfWork.Tridles.Data {
    ...
    public class TridleRepository : EntityRepository {
        ...
        public Querables ComposeQuerables (ITridleQuore quore, ITridleQueryPredicates preds) {
        ...
        public C LoadTridles<C> (ITridleQuore quore, ITridleQueryPredicates preds) where C:ITridleContainer, new() => LoadTridles (new C (), quore, preds);

        public C LoadTridles<C> (C container, ITridleQuore quore, ITridleQueryPredicates preds) where C : ITridleContainer {
